...
from spectrax.config import write_cfg, load_config_paths, SurveillanceConfig
from spectrax.paths import default_config_path, default_tls_paths
from spectrax.utils import (
    detect_host_ip,
...
from spectrax.constants import DEFAULT_PATHS
...
class SurveillanceSystem:
    ...
    def start_streaming_server(
        ...
        default_tls_key, default_tls_cert = default_tls_paths()
...
def detect(
    ...
    try:
        ...
        # Lazy import: visualizer → detector pulls torch/opencv ([cv] extra)
        from spectrax.visualizer import start_visualizer
